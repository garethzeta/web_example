...
<!-- Last Published: Tue May 10 2016 10:34:11 GMT+0000 (UTC) -->
...
<body class="body topics">
    ...
    <div class="hero-overlay">
      <div data-collapse="medium" data-animation="default" data-duration="400" data-contain="1" class="w-nav navigation-bar">
        <div class="w-container">
          <nav role="navigation" class="w-nav-menu"><a href="#" class="w-nav-link nav-link">Log in/Register</a>
          </nav>
          <div class="w-nav-button">
            <div class="w-icon-nav-menu"></div>
          </div><a href="new-homepage.html" class="w-nav-brand logo-container"><h1 class="logo-text"><strong>leave</strong>or<strong>stay</strong>.co.uk</h1></a>
        </div>
      </div>
      <div data-collapse="medium" data-animation="default" data-duration="400" data-contain="1" data-ix="stick-to-top" class="w-nav progress-navbar">
        <div class="w-container">
          <div class="what-page">\Immigration</div>
          <nav role="navigation" class="w-nav-menu w-clearfix"><a href="#" class="w-nav-link nav-link">Home</a><a href="#" class="w-nav-link nav-link">About</a><a href="#" class="w-nav-link nav-link">Contact</a>
			<?php  
			if (1>2) { 
			?> <div class="emot-nav"><img width="60" src="images/defence-01.png"><img width="60" src="images/trade-01.png"><img width="60" src="images/jobs-01.png"><img width="60" src="images/immi-01.png">
            </div> 
			<?php; 
			}
			?> 
      ...
      <div class="w-container hero-container immigration"><img src="images/immi-01.png" class="hero-image">
        ...
        <h1 class="hero-title title-2">Who can enter the UK?<br>Do we have 'control' of our borders?<br>Do migrants 'take' UK jobs?</h1><a href="#Intro--start" class="w-button hero-button">start topic</a><a href="sovereignty-and-the-law.html" class="w-button hero-button _2">Skip this topic</a>
      </div>
    </div>
  </div>
  ...
  <div id="Slider" class="w-section tb-slider-section">
    <div class="w-container">
      ...
      <h1 class="how-to-header">Let us know what you <strong class="highlight-word">think</strong> about immigration and the EU by reading the the cards and deciding which side you agree with most...</h1>
    </div>
    <div data-ix="first-think-card" class="w-container think-container">
      ...
      <div class="think-choice">
        <h1 class="which-way">Which way are you thinking?</h1><a data-ix="show-next-feel-card" class="w-button think-leave">Vote Leave</a><a data-ix="show-next-feel-card" class="w-button think-stay">Vote Stay</a><a data-ix="show-next-feel-card" class="w-button think-neither">Don't care</a>
      </div>
    </div>
    <div data-ix="feel-cards" class="w-container think-container-2">
      ...
      <div class="think-choice-2">
        <h1 class="which-way">Which way are you thinking?</h1><a data-ix="show-next-feel-card-2" class="w-button think-leave-2">Vote Leave</a><a data-ix="show-next-feel-card-2" class="w-button think-stay-2">Vote Stay</a><a data-ix="show-next-feel-card-2" class="w-button think-neither-2">Don't care</a>
      </div>
    </div>
    <div data-ix="feel-cards" class="w-container think-container-3">
      ...
      <div class="think-choice-3">
        <h1 class="which-way">Which way are you thinking?</h1><a href="#Finally" class="w-button think-leave-3">Vote Leave</a><a href="#Finally" class="w-button think-stay-3">Vote Stay</a><a href="#Finally" class="w-button think-neither-3">Don't care</a>
      </div>
    </div>
  </div>
  <div id="Finally" class="w-section section-1">
    <div class="w-container">
      <h1 class="next-button">Finally,</h1>
      <h1 class="how-to-header">Let us know how you <strong class="highlight-word">feel</strong> about the UK and the EU by reacting to a series of questions and answers...</h1>
            ...
            <div class="w-col w-col-4 column-1">
              <div class="card-4">
                <div class="sticky-footer test">
                  <h1 class="card-header-8">How many EU immigrants are looking for work?</h1>
                  ...
                  <div class="emoticon-div">
                    ...
                    <div class="emoticons-9"><img width="50" src="images/angry with word.png" data-ix="anger-selected-9" class="anger-9"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-9" class="shock-9"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-9" class="indifferent-9"><img width="50" src="images/happy with word.png" data-ix="happy-selected-9" class="happy-9"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-9" class="delighted-9">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4 column-2">
              <div class="card-5">
                <div class="sticky-footer">
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-5"><img width="50" src="images/angry with word.png" data-ix="anger-selected-5" class="anger-5"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-5" class="shock-5"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-5" class="indifferent-5"><img width="50" src="images/happy with word.png" data-ix="happy-selected-5" class="happy-5"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-5" class="delighted-5">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4 column-3">
              <div class="card-6">
                <div class="sticky-footer">
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-6"><img width="50" src="images/angry with word.png" data-ix="anger-selected-6" class="anger-6"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-6" class="shock-6"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-6" class="indifferent-6"><img width="50" src="images/happy with word.png" data-ix="happy-selected-6" class="happy-6"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-6" class="delighted-6">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4 column-1">
              <div class="card-10">
                <div class="sticky-footer">
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-10"><img width="50" src="images/angry with word.png" data-ix="anger-selected-10" class="anger-10"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-10" class="shock-10"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-10" class="indifferent-10"><img width="50" src="images/happy with word.png" data-ix="happy-selected-10" class="happy-10"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-10" class="delighted-10">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4">
              <div class="card-11">
                <div class="sticky-footer">
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-11"><img width="50" src="images/angry with word.png" data-ix="anger-selected-11" class="anger-11"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-11" class="shock-11"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-11" class="indifferent-11"><img width="50" src="images/happy with word.png" data-ix="happy-selected-11" class="happy-11"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-11" class="delighted-11">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4 column-3">
              <div class="card-12">
                <div class="sticky-footer">
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-12"><img width="50" src="images/angry with word.png" data-ix="anger-selected-12" class="anger-12"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-12" class="shock-12"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-12" class="indifferent-12"><img width="50" src="images/happy with word.png" data-ix="happy-selected-12" class="happy-12"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-12" class="delighted-12">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4 column-1">
              <div class="card-13">
                <div class="sticky-footer">
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-13"><img width="50" src="images/angry with word.png" data-ix="anger-selected-13" class="anger-13"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-13" class="shock-13"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-13" class="indifferent-13"><img width="50" src="images/happy with word.png" data-ix="happy-selected-13" class="happy-13"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-13" class="delighted-13">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4">
              <div class="card-14">
                <div class="sticky-footer">
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-14"><img width="50" src="images/angry with word.png" data-ix="anger-selected-14" class="anger-14"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-14" class="shock-14"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-14" class="indifferent-14"><img width="50" src="images/happy with word.png" data-ix="happy-selected-14" class="happy-14"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-14" class="delighted-14">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4 column-1">
              <div class="card-15">
                <div class="sticky-footer">
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-15"><img width="50" src="images/angry with word.png" data-ix="anger-selected-15" class="anger-15"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-15" class="shock-15"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-15" class="indifferent-15"><img width="50" src="images/happy with word.png" data-ix="happy-selected-15" class="happy-15"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-15" class="delighted-15">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4 column-2">
              <div class="card-16">
                <div class="sticky-footer">
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-16"><img width="50" src="images/angry with word.png" data-ix="anger-selected-16" class="anger-16"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-16" class="shock-16"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-16" class="indifferent-16"><img width="50" src="images/happy with word.png" data-ix="happy-selected-16" class="happy-16"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-16" class="delighted-16">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-col w-col-4 column-3">
              <div class="card-17">
                <div class="sticky-footer">
                  ...
                  <h1 class="headline-fact-long">Mixed outcomes.</h1><a href="#" data-ix="p14" class="w-button button-16">More info</a>
                  ...
                  <div class="emoticon-div">
                    <div class="how-emoticons-work">How does this make you feel?</div>
                    <div class="emoticons-17"><img width="50" src="images/angry with word.png" data-ix="anger-selected-17" class="anger-17"><img width="50" src="images/surprised with word.png" data-ix="shock-selected-17" class="shock-17"><img width="50" src="images/indifferent with word.png" data-ix="indifferent-selected-17" class="indifferent-17"><img width="50" src="images/happy with word.png" data-ix="happy-selected-17" class="happy-17"><img width="50" src="images/delighted with word.png" data-ix="delighted-selected-17" class="delighted-17">
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="w-section results">
    ...
    <div class="w-container">
      ...
      </div><a href="#" class="w-button results-button">SHOW MY RESULTS</a>
    </div>
  </div>
    ...
    <div class="w-container share-and-save">
      <div class="w-row">
        <div class="w-col w-col-6 save">
          <h1 class="save-and-share-header">Come back to this page</h1>
          <p class="save-and-share-body">Enter your email address and a password so that you can come back anytime as well as see updates on topics that matter to you.</p>
          <div class="w-form">
    ...
    <div class="w-row about-us">
      <div class="w-col w-col-4 our-pages">
        ...
        <div data-collapse="none" data-animation="default" data-duration="400" data-contain="1" class="w-nav footer-nav">
          <div class="w-container">
            <nav role="navigation" class="w-nav-menu"><a href="new-homepage.html" class="w-nav-link footer-page">Home</a><a href="about-us.html" class="w-nav-link footer-page">About Us</a><a href="the-black-and-white.html" class="w-nav-link footer-page">The Black &amp; White</a>
            </nav>
            <div class="w-nav-button">
              <div class="w-icon-nav-menu"></div>
            </div>
